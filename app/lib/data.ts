...
export async function fetchLatestInvoices() {
   try {
    ...
    `;
      ...
      const latestInvoices = (data as unknown as LatestInvoiceRaw[]).map(
         (invoice) => ({
            ...invoice,
...
export async function fetchInvoiceById(id: string) {
   try {
    ...
    `;
      ...
      const invoice = (data as unknown as InvoiceForm[]).map((invoice) => ({
         ...invoice,
...
export async function fetchFilteredCustomers(query: string) {
   try {
    ...
    `;
      ...
      const customers = (data as unknown as CustomersTableType[]).map(
         (customer) => ({
            ...customer,
